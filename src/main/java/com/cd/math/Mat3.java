...
public class Mat3 implements Function<Vec2, Vec2> {
    ...
    public static Mat3 translate(Vec2 vec) {
    ...
    public static Mat3 rotate(double rotation) {
    ...
    public static Mat3 rotate(double rotation, Vec2 origin) {
        return Mat3.translate(origin.mul(-1)).mul(Mat3.rotate(rotation)).mul(Mat3.translate(origin));
    }
